...
const Product = ({
    ...
    return (
        <Link href={`/category/${title}`} className="shape-box relative z-10 max-w-[500px] rounded-lg h-[450px] mx-auto overflow-hidden w-full text-left shape-box_half">
            <Image alt="products" className='w-[60%] h-[60%] absolute left-[50%] top-[35%] transform -translate-x-[50%] -translate-y-[50%]' src={imgSrc}></Image>
